...
(function() {
  ...
  window.Player = (function(_super) {
    ...
    function Player(levelWindow, collisionMap, assetQueue, spriteSheet, interactionKey) {
      ...
      this.yVelocity = 0;
      this.jumpCooldown = 0;
      this.jumpIsCoolingDown = this.interactionIsCoolingDown = this.isMovingLeft = this.isMovingRight = false;
      this.initialize();
    }
    ...
    Player.prototype.onTick = function(e, data) {
      var inTheCeiling, onTheGround, player;
      player = data.player;
      ...
      if (player.ranRightIntoWall()) {
        return player.x = Math.floor(player.x / 100) * 100 + 100 - player.constructor.WIDTH;
      }
    };
