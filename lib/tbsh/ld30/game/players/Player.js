...
(function() {
  ...
  window.Player = (function(_super) {
    ...
    Player.prototype.onTheGround = function() {
      return this.collisionMap.hitTest(this.x + 2, this.y + HEIGHT) || this.collisionMap.hitTest(this.x + 2, this.y + HEIGHT - 5) || this.collisionMap.hitTest(this.x + 2, this.y + HEIGHT - 15) || this.collisionMap.hitTest(this.x + WIDTH - 2, this.y + HEIGHT) || this.collisionMap.hitTest(this.x + WIDTH - 2, this.y + HEIGHT - 5) || this.collisionMap.hitTest(this.x + WIDTH - 2, this.y + HEIGHT - 15);
    };
