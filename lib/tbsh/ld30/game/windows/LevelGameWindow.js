...
(function() {
  ...
  window.LevelGameWindow = (function(_super) {
    ...
    LevelGameWindow.prototype.initialize = function() {
      ...
      return this.setupPedestalTriggers();
    };
    ...
    LevelGameWindow.prototype.setupPedestalTriggers = function() {
      var pedestal1A, pedestal1B, pedestal1F, pedestal1G;
      this.room1TopPedestals = [];
      this.room1BottomPedestals = [];
      ...
      this.room1TopPedestals.push(pedestal1B);
      ...
      this.room1BottomPedestals.push(pedestal1G);
      ...
      return this.watchPedestalTriggersInRoom1();
    };

    LevelGameWindow.prototype.watchPedestalTriggersInRoom1 = function() {
      var trigger, _i, _j, _len, _len1, _ref, _ref1, _results;
      _ref = this.room1TopPedestals;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        trigger = _ref[_i];
        trigger.watchPlayer(this.topPlayer);
      }
      _ref1 = this.room1BottomPedestals;
      _results = [];
