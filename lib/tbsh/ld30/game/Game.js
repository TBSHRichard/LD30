...
(function() {
  var FADESTATE_IN, FADESTATE_OFF, FADESTATE_OUT, HEIGHT, WIDTH, game;
  ...
  window.Game = (function() {
    ...
    Game.prototype.setAssetQueue = function(assetQueue) {
      this.assetQueue = assetQueue;
      return this.setWindow(new LevelGameWindow(WIDTH, HEIGHT));
    };
